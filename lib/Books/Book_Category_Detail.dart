...
import 'package:harekrishnagoldentemple/Books/Book_Detail.dart';
...
class SPBCD extends StatefulWidget {
  final String category;
  const SPBCD({super.key, required this.category});

  @override
  State<SPBCD> createState() => _SPBCDState();
}

class _SPBCDState extends State<SPBCD> {
      ...
      body: SingleChildScrollView(
        ...
        children: [
          ...
          StreamBuilder<QuerySnapshot>(
            stream: FirebaseFirestore.instance.collection("Books-Slider").where("Category", isEqualTo: widget.category).snapshots(),
...
Widget sevaCard(String description, price, category, imageTwo, image, title, caption, id,
                    ...
                    children: [
                      ...
                      Padding(
                        ...
                        child: ElevatedButton(
                         ...
                         builder: (context) => SPDetail(img2: imageTwo,  img: image,category: category, title: title, description: description, price: price)));
                          },
