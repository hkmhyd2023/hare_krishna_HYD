...
late YoutubePlayerController _controller;
  ...
  @override
  Widget build(BuildContext context) {FirebaseMessaging.instance.getToken().then((token) {
      print(token);
    });
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            SettingItemWidget(
              leading: FaIcon(FontAwesomeIcons.donate, color: context.iconColor),
              title: "My Sevas",
              titleTextStyle: boldTextStyle(),
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => YourSevaList()));
              },
              trailing: Icon(Icons.arrow_forward_ios_rounded,
                  size: 18, color: context.iconColor),
            ),
            SettingItemWidget(
              leading: FaIcon(FontAwesomeIcons.cartShopping, color: context.iconColor),
              title: "My Orders",
              titleTextStyle: boldTextStyle(),
              onTap: () {
                Navigator.of(context)
                    .push(MaterialPageRoute(builder: (context) => YourOrdersList()));
              },
              trailing: Icon(Icons.arrow_forward_ios_rounded,
                  size: 18, color: context.iconColor),
            ),
